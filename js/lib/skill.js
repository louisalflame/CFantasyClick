...
var skills = {
	...
	a1_6 : {
		...
		run: () => {
			...
			app.standPerSec = app.standPerSec.plus(6);
			app.life = app.life.plus(1);
		},
	...
	a1_7 : {
		...
		run: () => {
			...
			app.standPerSec = app.standPerSec.plus(8);
			app.life = app.life.plus(1);
		},
	...
	c0_7 : {
		...
		run: () => {
			...
			app.standPerSec = app.standPerSec.minus(8);
		},
	...
	c1_3 : {
		...
		run: () => {
			...
			app.standPerSec = app.standPerSec.minus(12);
		},
	...
	c1_4 : {
		...
		run: () => {
			...
			app.standPerSec = app.standPerSec.minus(14);
		},
		getPrev: () => { return skills.c1_3 },
		getNext: () => { return skills.c1_5 },
	},
	c1_5 : {
		id: 'c1_5',
		top: false,
		...
		run: () => {
			...
			app.standPerSec = app.standPerSec.minus(16);
		},
		getPrev: () => { return skills.c1_4 },
		getNext: () => { return skills.c1_6 },
	},
	c1_6 : {
		id: 'c1_6',
		top: false,
		...
		run: () => {
			...
			app.standPerSec = app.standPerSec.minus(18);
			app.renown = app.renown.minus(7);
			app.life = app.life.minus(5);
		},
		getPrev: () => { return skills.c1_5 },
		getNext: () => { return skills.c1_7 },
	},
	c1_7 : {
		id: 'c1_7',
		top: true,
